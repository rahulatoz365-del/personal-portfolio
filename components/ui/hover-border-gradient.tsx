...
>) {
  // 1. FIXED: Bypasses TypeScript's strict construct signature check for dynamic tags
  const Tag = as as any; 
  ...
  return (
    <Tag
      ...
      className={cn(
        // 2. FIXED: Changed 'decoration-clone' to modern Tailwind v4 'box-decoration-clone'
    ...
    >
      ...
      />
      {/* 3. FIXED: Changed 'inset-[2px]' to clean canonical 'inset-0.5' */}
